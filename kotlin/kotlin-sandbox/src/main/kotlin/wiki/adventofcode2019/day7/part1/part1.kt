package wiki.adventofcode2019.day7.part1
...
fun main() {
    ...
    val phaseCombinations = permutations(listOf(0, 1, 2, 3, 4))

//    val rawProgram = "3,15,3,16,1002,16,10,16,1,16,15,15,4,15,99,0,0"
