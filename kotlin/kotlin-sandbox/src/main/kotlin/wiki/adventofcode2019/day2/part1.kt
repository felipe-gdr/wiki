...
fun main() {
    ...
    println(execute("1,0,0,0,99"))
    println(execute("2,3,0,3,99"))
    println(execute("2,4,4,5,99,0"))
    println(execute("1,1,1,4,99,5,6,0,99"))
    ...
    val result = execute(input.joinToString(","))
